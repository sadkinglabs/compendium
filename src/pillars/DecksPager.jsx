...
// The last buildability map, kept across pillar mounts (module state, same pattern as artCache's
// memo) so Library badges paint on the first frame instead of popping in and resizing the tiles.
